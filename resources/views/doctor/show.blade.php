            ...
            <div class="card-body">
                <div class="row mt-3">
                    ...
                    <div class="col-md-9">
                        ...
                        @role('Patient')
                            <a href="{{ route('patient-calendar', $doctor) }}?is-physical=0" class="btn btn-primary">Online Schedule</a>
                            <a href="{{ route('patient-calendar', $doctor) }}?is-physical=1" class="btn btn-primary">Physical Schedule</a>
                        @endrole
                    </div>
