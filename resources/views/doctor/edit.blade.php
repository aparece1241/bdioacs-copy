                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="contact_number" type="text"
                                ...
                                value="{{ $doctor->user->contact_number }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" type="email" class="form-control  @error('email') is-invalid @enderror"
                                name="email" placeholder="example@domain.com" value="{{ $doctor->user->email }}" required
                        ...
                        <div class="input-group">
                            ...
                            <select id="secretary" type="secretary" class="form-control"
                                ...
                                @foreach($secretaries as $secretary)
                                    @if(old('secretary', ($doctor->secretary) ? $doctor->secretary->id : null))
